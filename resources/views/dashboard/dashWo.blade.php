    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card bg-c-blue">
                    <div class="card-block ">
                        <h6 class="m-b-20">Total Work Order</h6>
                        <h2 class="text-right"><i class="ti-agenda f-left"></i><span>{{ $totalWo }}</span></h2>
            ...
            <div class="col">
                <div class="card bg-c-green order-card">
                    <div class="card-block">
                        <h6 class="m-b-20">Total WO Done</h6>
                        <h2 class="text-right"><i class="ti-check-box f-left"></i><span>{{ $totalDone }}</span></h2>
            ...
            <div class="col">
                <div class="card bg-c-yellow order-card">
                    <div class="card-block">
                        <h6 class="m-b-20">Total WO Pending</h6>
                        <h2 class="text-right"><i class="ti-reload f-left"></i><span>{{ $totalPending }}</span></h2>
            ...
            <div class="col">
                <div class="card bg-c-pink order-card">
                    <div class="card-block">
                        <h6 class="m-b-20">Total WO Cancel</h6>
                        <h2 class="text-right"><i class="ti-back-right f-left"></i><span>{{ $totalCancel }}</span></h2>
            ...
            <div class="col">
                <div class="card bg-info order-card">
                    <div class="card-block">
                        <h6 class="m-b-20">Total WO On Progress</h6>
                        <h2 class="text-right"><i class="ti-control-play f-left"></i><span>{{ $totalProgress }}</span></h2>
                        {{-- <p class="m-b-0">This Month<span class="f-right">$542</span></p> --}}
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <canvas id="Statistics-chart" height="auto"></canvas>
                </div>
            </div>
        </div>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [15, 30, 35, 25, 20, 30],
                    borderWidth: 1
                },{
                    label: 'Work Order Done',
                    data: [10, 20, 30, 20, 12, 13],
                    borderWidth: 1
                }]
            },
            options: {
