                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-10">
                            ...
                            <hr>
                            <form action="{{ route('fat.update', $fatedit->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row">
                                        ...
                                        <select name="branch" class="form-control" id="branch">
                                            ...
                                            @foreach ($branchopt as $branchlist)
                                                <option value="{{ $branchlist->id }}"
                                                    {{ $branchlist->id == $fatedit->branch_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control" name="kode_branch" id="kode_branch"
                                            readonly value="{{ old($fatedit->kode_area) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <select name="areaFat" id="areaFat"
                                            ...
                                            <option value="{{ old($fatedit->area) }}" selected>{{ old($fatedit->area) }}
                                            </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control" name="kode_cluster" id="kode_cluster"
                                            placeholder="Input Kode Cluster" value="{{ $fatedit->kode_cluster }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control" name="cluster" id="cluster"
                                            placeholder="Input Cluster" value="{{ $fatedit->cluster }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control" name="homepas" id="homepas"
                                            placeholder="Input Jumlah Home Pas" value="{{ $fatedit->hp }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <select name="ms_regular" id="ms_regular"
                                            ...
                                            <option value="Manage Service"
                                                {{ 'Manage Service' == $fatedit->ms_regular ? 'selected' : '' }}>
                                                {{ $fatedit->ms_regular }}</option>
                                            <option value="Non Manage Service"
                                                {{ 'Non Manage Service' == $fatedit->ms_regular ? 'selected' : '' }}>
                                                {{ $fatedit->ms_regular }}</option>
                                        </select>
                                        @error('areaFat')
                                            <div class="invalid-feedback">{{ $message }}</div>
