...
<![endif]-->
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="http://127.0.0.1:8000/assets/images/favicon.ico" type="image/x-icon">
    <!-- Google font-->
    ...
    <link href="http://127.0.0.1:8000/assets/datatables/datatables-1.13.6/css/jquery.datatables.min.css"
        rel="stylesheet">
...
<![endif]-->
    ...
    <!-- Required Jquery -->
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/jquery/jquery.min.js"></script>
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/jquery-ui/jquery-ui.min.js"></script>
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/popper.js/popper.min.js"></script>
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/bootstrap/js/bootstrap.min.js"></script>
    <!-- jquery slimscroll js -->
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/jquery-slimscroll/jquery.slimscroll.js"></script>
    <!-- modernizr js -->
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/modernizr/modernizr.js"></script>
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/modernizr/css-scrollbars.js"></script>

    <!-- Custom js -->
    <script type="text/javascript" src="http://127.0.0.1:8000/assets/js/script.js"></script>

    <script src="http://127.0.0.1:8000/assets/js/vartical-demo.js"></script>
    <script src="http://127.0.0.1:8000/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="http://127.0.0.1:8000/assets/js/pcoded.min.js"></script>
