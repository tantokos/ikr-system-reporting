...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset('assets/images/logo-misitel.png') }}" type="image/x-icon">
    <!-- Google font-->
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        ...
                        <form action="{{ route('register.proses') }}" method="POST" class="md-float-material">
                            @csrf

                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <img src="{{ asset('assets/images/logo-misitel-ico2.png') }}" alt="logo.png">
                                ...
                                <div class="input-group">
                                    <input type="text" name="nama" class="form-control" placeholder="Your Name" value="{{ old('nama') }}" required>
